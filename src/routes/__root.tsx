...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Transform your body and build your legacy at IRONFORGE. Elite trainers, world-class equipment, and a community that never quits." },
      { property: "og:title", content: "IRONFORGE — Elite Premium Fitness Club" },
      { property: "og:description", content: "Elite trainers, world-class equipment, cinematic training experience." },
